...
Pod::Spec.new do |s|
  s.name             = 'MAGDebugKit'
  s.version          = '0.1.0'
  s.summary          = 'A short description of MAGDebugKit.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/MAGDebugKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Evgeniy Stepanov' => 'stepanov@magora.systems' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/MAGDebugKit.git', :tag => s.version.to_s }
